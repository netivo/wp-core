...
class Annotations {
	 ...
	 */
	public static function get_class_annotations( string $className ) {
	 ...
	 */
	protected static function parse_annotations( string $docblock ) {
		$annotations = array();
	 ...
	 */
	protected static function parse_args( string $content ) {
		$data  = array();
		$len   = strlen( $content );
		$i     = 0;
		$var   = '';
	 ...
	 */
	public static function get_method_annotations( string $className, string $methodName ) {
